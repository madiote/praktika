  ...
  <div data-role="page" id="corridors">
    ...
    <div class="corridorEditor">
      ...
      <div class="instructions">
        ...
        <p>Koridorihalduri eesmärgiks on võimaldada kaardisüsteemil navigeerida ühest ruumist teise. Haldur aitab hallata kahte faili:</p>
        <ol>
          <li>Koordinaadid ehk network.json - kirjeldab ruumide "uksi", millest ning milleni navigatsioonisüsteem kasutaja suunab</li>
          <li>Navigatsioon ehk pathing.json - kirjeldab ruumide seoseid, ehk millised ruumid on üksteise lähedal, et oleks võimalik nende vahel navigeerida</li>
        </ol>
        ...
        <ol>
          ...
          <li>Lift_NNN, näiteks Lift_401 - kirjeldab lifti, mida kasutatakse, kui see on lähim moodus ühelt korruselt teise liikumiseks</li>
          <li>Trepp_NNN, näiteks Trepp_402 - kirjeldab treppi, mida kasutatakse, kui see on lähim moodus ühelt korruselt teise liikumiseks</li>
        </ol>
        ...
        <ol>
          ...
          <li>Sorteeri - võimaldab objekte failis ümber sorteerida, soovitav on seda mitte kasutada ning säilitada esialgne järjestus</li>
        ...
        <ol>
          ...
          <li>Laadi originaal - laadib serverist esialgse faili (nt "network-default.json"), salvestades KIRJUTATAKSE VALITUD FAIL ÜLE (nt "network.json")</li>
          <li>Vahemaa kalkulaator - sisestades 2 ruumi nime annab tööriist nende vahemaa koordinaadiühikutes, mida saab sisestada sisestada navigatsiooni "pathing" faili</li>
        </ol>
      </div>
    </div>
    <div class="ui-footer ui-bar-a" data-swatch="a" data-theme="A" data-form="ui-bar-a" data-role="footer"
