            ...
            if (isMareUsed) {
                if (getRoomFloor(pA) == 2) {
                   instructionsField.innerHTML = instructionsPrefix + "Liikuge mööda kaardil kuvatud teed.";
                    ...
                    if (startBuilding == "Mare") {
                       instructionsField.innerHTML = instructionsPrefix + "Liikuge trepist alla 2. korrusele. Sealt liikuge Mare majast Terra majja ja Terra majas trepist/liftist " + getRoomFloor(endPoint) + ". korrusele.";
                    } else {
            ...
            if (isMareUsed) {
                if (startBuilding == "Mare") {
                    if (getRoomFloor(startingPoint) == 2) {
                        if(isEndLocked){
                            instructionsField.innerHTML = instructionsPrefix + "Liikuge Terra majja. Seal liikuge trepist/liftist 5. korrusele. Seal liikuge kaardil märgitud trepist tagasi 4. korrusele.";
                        }else{
                            instructionsField.innerHTML = instructionsPrefix + "Liikuge Terra majja. Seal liikuge trepist/liftist " + getRoomFloor(endPoint) + ". korrusele.";
                        }
                    } else {
                        if (isEndLocked) {
                           instructionsField.innerHTML = instructionsPrefix + "Liikuge trepist/liftist 2. korrusele. Sealt liikuge Terra majja ja trepist/liftist 5. korrusele. Sealt liikuge kaardil märgitud trepist 4. korrusele.";
                        } else {
                           instructionsField.innerHTML = instructionsPrefix + "Liikuge trepist/liftist 2. korrusele. Sealt liikuge Terra majja ja trepist/liftist " + getRoomFloor(endPoint) + ". korrusele.";
                        }
                    }
                } else {
                    if (getRoomFloor(startingPoint) == 2) {
