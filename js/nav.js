            ...
            if (isMareUsed) {
                if (startBuilding == "Mare") {
                    if (getRoomFloor(startingPoint) == 2) {
                        if(isEndLocked){
                            instructionsField.innerHTML = instructionsPrefix + "Liikuge Tera majja. Seal liikuge trepist/liftist 5. korrusele. Seal liikuge kaardil märgitud trepist tagasi 4. korrusele.";
                        }else{
